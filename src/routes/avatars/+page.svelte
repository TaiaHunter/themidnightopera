...
<Columns>
	<Column weight={1}>
		<DoubleBorder>
			...
			<p>
				She was designed by the Founder and Owner of The Midnight Opera herself, Taia Huntercat, and
...
<Columns>
	...
	<Column weight={1}>
		<DoubleBorder>
			...
			<p>
				This avatar was designed by Taia Huntercat (Founder and Owner of The Midngiht Opera) and
				will be brought to life by KoshoKreations.
			</p>
		</DoubleBorder>
	</Column>
</Columns>
